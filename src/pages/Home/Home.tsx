...
export default function Home() {
  ...
  // - Section avec des boutons qui rediriges vers les différentes sections de la page d'acceuil basé sur le useRef qui prend 90% de viewHeight
          ...
          <div className="home-redirection-actions">
            {redirectionLinks.map((link) => (
              <button
                ...
                onClick={() => handleSectionRedirect(link.targetId)}
              >
                {link.label}
              </button>
            ))}
