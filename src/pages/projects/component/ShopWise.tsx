    ...
    <article className="competence-detail" aria-labelledby="organisation-title">
      ...
      <section className="competence-sub-item">
        ...
        <p>
          ...
          autonomie, au sein duquel j'ai intégré l'équipe projet en tant que chargé de conception. À
          ce titre, j'étais responsable de la réflexion architecturale ainsi que de l'implémentation
          technique de la solution. Ce projet m'a permis de mobiliser l'ensemble des compétences
          acquises au cours de ma formation, en me confrontant à des problématiques concrètes de
      ...
      <section className="competence-sub-item">
        ...
        <p>
          ...
          librairies, salons de coiffure, ces petites structures n'ont bien souvent ni les moyens ni
          les ressources pour s'équiper d'outils de gestion performants. ShopWise ambitionne de
          combler ce manque en centralisant la gestion des stocks, des ventes et des rendez-vous au
          sein d'une solution simple et abordable.
          <br />
          <br />
          ...
          illustraient un risque réel pour la maintenabilité et les performances du produit, et ont
          orienté l'ensemble des choix techniques réalisés au cours de cette mission.
        </p>
      </section>
      ...
      <section className="competence-sub-item">
        ...
        <p>
          ...
          côté client, le produit s'adresse en premier lieu aux commerçants indépendants : épiciers,
          libraires, coiffeurs, et tous ceux qui gèrent leur activité sans véritable outil
          numérique. Pour incarner cet utilisateur cible, le projet s'appuie sur le profil fictif
          d'une propriétaire d'épicerie locale, représentative de cette clientèle. Ses besoins sont
          simples et concrets : gagner du temps, simplifier la gestion quotidienne de son commerce
          et accéder à une solution digitale sans que cela lui coûte une fortune.
          <br />
          <br />
          Du côté de l'équipe projet, la solution est portée par ShopWise SaaS, la startup éditrice
          de la plateforme. C'est elle qui exprime le besoin et définit la vision produit. En tant
          que membre de cette équipe, j'étais chargé de la conception avancée et de l'implémentation
          backend, avec la responsabilité de traduire les besoins métier en décisions techniques
        ...
        <p>
          La stack technique était imposée dans le cadre du projet. Le backend devait être développé
          en Java avec le framework Spring Boot, et s'appuyer sur une base de données relationnelle,
          PostgreSQL ou MySQL. Côté outillage, le projet devait être versionné sur un repository
          GitHub public respectant une structure imposée, conteneurisé via Docker, et couvert par
          des tests unitaires et d'intégration écrits avec JUnit, Mockito et Spring Test. La
          documentation technique était attendue en Markdown, accompagnée de diagrammes UML.
          <br />
          <br />
          Au-delà de la stack, plusieurs contraintes structurantes ont guidé l'ensemble des choix de
          conception. Le respect du RGPD imposait une gestion sécurisée des données personnelles des
          clients des commerces. L'architecture devait être pensée pour supporter plusieurs
          commerces et plusieurs utilisateurs simultanément, dans une logique de scalabilité. Bien
          que le frontend ne soit pas dans le périmètre du projet, l'interface devait être conçue
          pour être responsive. Enfin, la modularité était une exigence explicite, notamment pour
          isoler le module de recommandations et faciliter les évolutions futures.
          <br />
          <br />
      ...
      <section className="competence-sub-item">
        ...
        <p>
          ...
          complexes ou trop coûteuses. Pour convaincre ce public, la plateforme doit avant tout être
          simple à prendre en main et accessible financièrement. La valeur perçue est clé : si le
          commerçant ne ressent pas rapidement un gain de temps ou une amélioration de son
          quotidien, il abandonnera l'outil.
          <br />
          <br />
          L'autre enjeu business est celui de la différenciation. ShopWise évolue dans un marché où
          des acteurs comme Shopify ou des logiciels métiers spécialisés sont déjà bien implantés.
          Pour s'imposer, la plateforme mise sur un module de recommandations basé sur
          ...
          s'agisse du paiement en ligne, d'un chatbot ou d'autres services encore non définis. Elle
          doit également tenir la charge dans un contexte multi-commerces et multi-utilisateurs.
          <br />
          <br />
          La sécurité est un autre enjeu majeur. Les données personnelles des clients sont soumises
          au RGPD, et les opérations sensibles comme les ventes ou les modifications de stock
          doivent être protégées. Cela passe par une authentification robuste, reposant sur des
          tokens et une gestion fine des rôles utilisateurs.
          <br />
          <br />
      ...
      <section className="competence-sub-item">
        <h2>Les risques</h2>
        <p>
          L'API manipule des données sensibles : ventes, stocks, informations clients. Une faille de
          sécurité, qu'il s'agisse d'une injection SQL, de tokens JWT mal configurés ou d'une
          gestion des rôles insuffisante, pourrait exposer l'ensemble de ces données à des acteurs
          malveillants. Un scénario concret serait celui d'un token JWT sans expiration permettant à
          un ancien employé de conserver un accès au système, ou d'un attaquant exploitant une
          ...
          devenir un goulot d'étranglement. En cas de pic de trafic, par exemple lors de périodes de
          soldes, le service pourrait devenir lent voire indisponible. Pour un commerçant qui
          ...
          qui ne sont jamais achetés ensemble. Dans ce cas, les commerçants ignoreraient simplement
          la fonctionnalité, annulant tout l'intérêt du module. À cela s'ajoute un risque de
          performance. Si le calcul des recommandations génère des temps de réponse trop longs, il
          peut impacter l'ensemble de l'API et introduire une dette technique difficile à résorber.
        </p>
      </section>
      ...
      <section className="competence-sub-item">
        ...
        <p>
          ...
          ligne de code, il était nécessaire de définir clairement les responsabilités de chaque
          ...
          nouvelles fonctionnalités ; la robustesse, en isolant les modules pour contenir les effets
          d'une éventuelle défaillance ; et la testabilité, chaque module pouvant être vérifié de
        ...
        <p>
          ...
          réalisée afin de comprendre la structure en place, d'identifier les conventions utilisées
        ...
        <p>
          ...
          le catalogue produits, et quel type de recommandations serait produit, comme la suggestion
      ...
      <section className="competence-sub-item">
        ...
        <p>
          ...
          enrichir l'application d'une dimension plus intelligente, en proposant des recommandations
          produits basées sur les données réelles de ventes et de catalogue.
        </p>
      ...
      <section className="competence-sub-item">
        ...
        <p>
          ...
          des étapes d'un développement logiciel : de la définition du périmètre fonctionnel jusqu'à
          l'intégration d'un module de machine learning, en passant par la sécurisation de l'API et
          la mise en place de tests. Il m'a également conforté dans ma volonté d'appliquer ces
          compétences dans un contexte réel, au sein d'une entreprise, où les contraintes métier,
          les exigences de qualité et les interactions humaines viennent donner une toute autre
          dimension aux choix techniques.
        </p>
      </section>
    </article>
  )
