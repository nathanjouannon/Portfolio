      ...
      <article className="competence-detail" aria-labelledby="organisation-title">
        ...
        <section className="competence-sub-item">
          ...
          <p>
            ...
            <br />
            <br />
            Mon poste est celui de développeur application mobile, disponible sur iOS et Android.
            J'ai été en charge de la modification des pages existantes, de la création des pages
        ...
        <section className="competence-sub-item">
          ...
          <p>
            ...
            <br />
            <br />
            Ce projet impliquait une communication constante avec les différents acteurs de
            l'équipe. En début de semaine, des échanges avec le CEO permettaient de définir les
            fonctionnalités à développer ou les modifications à apporter. Je collaborais également
            étroitement avec le développeur back-end pour aligner nos échanges autour de l'API :
            définir les données à envoyer, celles retournées, et s'assurer de leur cohérence. Le
            designer UI/UX était aussi un interlocuteur régulier pour garantir la bonne intégration
            des maquettes. Enfin, je travaillais avec le second développeur de l'application,
            notamment pour les code reviews via GitHub.
            <br />
            <br />
            L'objectif principal était de maintenir et faire évoluer l'application mobile
            cross-plateforme, développée en React Native, pour qu'elle reste disponible et à jour
            sur iOS et Android. Cela impliquait de livrer une application sécurisée, intuitive et
        ...
        <section className="competence-sub-item">
          ...
          <p>
            ...
            <br />
            <br />
            L'application est cross-plateforme, disponible sur iOS et Android. Elle a été
            initialement créée avec Create React App, puis migrée vers Expo, en utilisant non pas
            Expo Go mais l'Expo Development Server.
            <br />
            <br />
            ...
            <br />
            <br />
            Sur le plan technique, l'application est développée en React Native avec TypeScript.
            Elle s'appuie sur plusieurs librairies, notamment i18n pour la gestion des traductions
            et Zustand pour la gestion des états globaux, entre autres.
            <br />
            <br />
            ...
            sous-dossiers : components pour les composants propres à la feature, hooks pour les
            hooks d'accès à l'API, et styles pour les styles. En parallèle, des dossiers globaux à
        ...
        <section className="competence-sub-item">
          ...
          <p>
            ...
            un bouche-à-oreille négatif. La fiabilité des coupons est donc un enjeu de rétention et
            de réputation pour l'entreprise.
          </p>
        </section>
        ...
        <section className="competence-sub-item">
          ...
          <p>
            ...
            cette étape est défaillante, l'utilisateur ne pourra jamais accéder à l'application et
            il est peu probable qu'il y revienne.
            <br />
            <br />
            ...
            <br />
            <br />
            Enfin, la cybersécurité représente un risque important. Les coupons offrent des
            avantages tarifaires significatifs, ce qui en fait des cibles potentielles. Pour limiter
            ce risque, plusieurs mécanismes ont été mis en place, notamment le fait qu'un coupon ne
            soit utilisable qu'une seule fois sur le e-commerce de la marque partenaire.
          </p>
        </section>
        ...
        <section className="competence-sub-item">
          ...
          <p>
            ...
            l'absence de traçabilité : en cas de bug ou de problème, il était impossible de savoir
            qui avait effectué quelle action, ce qui rendait le débogage très difficile.
            <br />
            <br />
            ...
            <br />
            <br />
            Le parcours de création de compte a également été restructuré. L'utilisateur commence
            par renseigner un code d'invitation, seul moyen d'accéder à la création de compte. Il
            ...
            Une recherche automatique est effectuée via l'API publique du ministère des Sports, en
            se basant sur son nom, prénom et date de naissance, afin de vérifier s'il possède une
            carte professionnelle d'éducateur sportif. Si la vérification aboutit, l'utilisateur est
            directement redirigé vers le catalogue des réductions. Dans le cas contraire, il est
            invité à importer manuellement un justificatif de diplôme, qui sera ensuite vérifié par
            un administrateur.
            <br />
            <br />
          ...
          <p>
            ...
            la nouvelle charte graphique. Cette phase a également été l'occasion de mettre en place
            un design system, permettant d'uniformiser le style de l'application et de centraliser
            toutes les variables de style en un seul endroit. Ainsi, modifier une seule variable
            suffit à répercuter un changement sur l'ensemble de l'application, que ce soit pour les
            couleurs, les tailles de fonte ou d'autres propriétés visuelles.
            <br />
            <br />
            ...
            désormais définies et gérées via le design system. L'uniformisation des fontes a
            également fait partie de ce chantier. Les tailles et styles de texte étaient auparavant
            définis de manière disparate à travers l'application. L'ensemble a été regroupé et
            standardisé via des variables communes, spécifiant pour chaque usage la taille et le
            style appropriés.
          </p>
          ...
          <p>
            ...
            <br />
            <br />
            Le travail principal a consisté à modifier le parcours de création de compte, notamment
            à l'étape d'import de diplôme, en ajoutant un champ permettant à l'utilisateur de
            renseigner le pays d'origine de son diplôme. Ce champ est ensuite utilisé par les
            administrateurs lors de la vérification manuelle du diplôme pour attribuer à
            l'utilisateur un tag pays. Ce système permet d'intégrer des utilisateurs européens dont
            les diplômes proviennent de différents pays.
            <br />
            <br />
            ...
            duplications de marques dans leur catalogue de réductions, certaines marques
            apparaissant plusieurs fois avec des conditions différentes. Pour résoudre ce problème,
            un algorithme a été développé afin de sélectionner automatiquement la réduction la plus
            avantageuse pour chaque marque, garantissant ainsi un catalogue sans doublon.
          </p>
        </section>
        ...
        <section className="competence-sub-item">
          ...
          <p>
            ...
            d'identifier à quelle étape certains abandonnent. Grâce à cet outil, il a été constaté
            que 98% des créations de compte se terminent désormais avec succès, contre 85% avant les
          ...
          <p>
            ...
            sa base d'utilisateurs, ayant dépassé le seuil des 500 connexions quotidiennes.
            <br />
            <br />
            Cette croissance soulève un enjeu technique important pour les prochaines releases :
            l'optimisation des performances. Avec un nombre d'utilisateurs en constante
            augmentation, des appels inutiles ou redondants à l'API peuvent rapidement devenir
            problématiques. Si le nombre d'utilisateurs venait à doubler, comme cela est anticipé,
            des lenteurs pourraient apparaître notamment lors des pics d'activité. Un travail
            d'audit et d'optimisation des performances est donc prévu afin d'anticiper cette montée
            en charge et de garantir une expérience utilisateur fluide quel que soit le volume de
        ...
        <section className="competence-sub-item">
          ...
          <p>
            ...
            prendre en compte, notamment le débogage, qui s'avère plus complexe, ou encore la
            gestion des releases, bien plus contraignante que sur le web. Même si des solutions
            comme l'hébergement d'Expo sur un VPS privé permettent de simplifier la distribution des
            mises à jour, cela reste un processus plus lourd qu'un simple déploiement web.
            <br />
            <br />
