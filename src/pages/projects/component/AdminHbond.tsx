      ...
      <article className="competence-detail" aria-labelledby="organisation-title">
        ...
        <section className="competence-sub-item">
          ...
          <p>
            ...
            que projet de fond mené en parallèle des autres missions. Il n'a pas constitué la charge
            principale de mon temps, mais a progressé de manière continue tout au long de la
            période, et est toujours en cours aujourd'hui.
            <br />
            <br />
        ...
        <section className="competence-sub-item">
          ...
          <p>
            L’équipe qui réalise le projet est composée de 4 personnes. Il y a un developpeur
            backend, il assure seul la maintenance et la création de nouvelles fonctionnalités. Il y
            a également le CEO, son but est de nous transmettre ses besoins afin qu’ils soient mit
            en place. De plus, le responsable commercial et marketing fait partie du projet car il
            est l’utilisateur principale de cette outils d’admin. Et enfin un deuxième développeur
            est dans le projet pour compléter mon travail et pour review une partie du code produit.
            <br />
            <br />
            Le contexte humain est une équipe avec des lieux de travails mixtes. Les personnes qui
            exprimes leurs besoins sont dans les bureau de l’entreprise à temps pleins. Le
            developpeur backend lui est complètement en télétravail. Je suis sur un emploi du temps
            qui mixte le télétravail ( 1 à 2 jour par semaine ) et la présence au bureau les autres
            jours. Et le deuxième développeur travail pour l’entreprise 2 jours par semaines. Nous
            avons donc un contexte humains ou les équipe sont assez éloigné, il y a un enjeux de
            garder de la communication.
          </p>
          ...
          <p>
            ...
            pages couvrent les fonctionnalités suivantes : la gestion des discounts, la validation
            des certifications, la visualisation des statistiques et la gestion des codes
            d'invitation.
            <br />
            <br />
        ...
        <section className="competence-sub-item">
          ...
          <p>
            ...
            l'application admin. En effet, le système en place présentait une faille
            organisationnelle importante : l'ensemble des utilisateurs de l'admin se connectaient
            via un unique compte partagé, sans identité propre. Il était donc impossible de savoir
            quelle personne avait réalisé quelle action, ce qui posait un problème évident de
            traçabilité et de responsabilité.
            <br />
            Pour remédier à cela, j'ai modifié l'endpoint de connexion afin de migrer vers un
            système de sessions côté serveur, permettant à chaque utilisateur de disposer de son
            propre compte. Cette modification a également impliqué une refonte de la gestion du
            cache et du localStorage côté frontend, pour s'assurer que les données de session soient
            correctement initialisées et nettoyées à la connexion et à la déconnexion.
          </p>
          ...
          <p>
            ...
            pas été définies en une seule fois au départ, mais ont émergé et évolué progressivement
            au fil des échanges avec les parties prenantes.
            <br />
            <br />
            Ces échanges prenaient plusieurs formes selon les situations : des réunions dédiées pour
            cadrer les grandes évolutions, des discussions informelles au bureau pour des
            ajustements rapides, ou des échanges écrits via les outils de communication de l'équipe.
            Une fois les besoins identifiés, ils étaient formalisés sous forme d'issues dans Linear,
            notre outil de gestion de projet, ce qui permettait de les prioriser, de les suivre et
            d'en garder une trace écrite.
            <br />
            <br />
            ...
            tels quels. Ces allers-retours avec le CEO et le responsable commercial ont été
            essentiels pour aboutir à des spécifications réalistes et cohérentes avec les
            contraintes techniques du projet. J'impliquais également le développeur backend dans ces
            échanges, notamment pour valider la faisabilité côté API avant de commencer le
            développement.
          </p>
          ...
          <p>
            ...
            fonctionnalité débutait par une modification du router React pour y intégrer les
            nouvelles routes, avant de passer à l'implémentation de la page elle-même.
            <br />
            <br />
            N'ayant pas de maquettes à disposition. Le CEO ayant fait le choix de concentrer les
            efforts de design sur l'application utilisateur. J'ai conçu moi-même l'interface de
            chaque page, en plaçant l'expérience utilisateur au centre de mes décisions. L'objectif
            était de produire une interface claire, cohérente et agréable à utiliser pour des
            personnes non-techniques amenées à s'en servir quotidiennement.
            <br />
            <br />
            ...
            <br />
            <br />
            La page de validation des certifications affiche les demandes de validation de diplôme
            qui n'ont pas pu être traitées automatiquement via la connexion avec l'API du ministère
            des Sports. Les demandes sont organisées en quatre statuts (en attente, en cours,
            terminé et archivé) et chaque demande dispose d'une page dédiée regroupant toutes les
            informations utiles à l'administrateur : informations du compte, parrain éventuel, tags
            d'activité demandés, pièces justificatives, autres demandes en cours et diplômes déjà
            validés.
            <br />
            <br />
            ...
            de réduction, tags éligibles et statistiques d'utilisation des coupons associés. Un
            second onglet permet de suivre la disponibilité des coupons par type de source
          ...
          <p>
            ...
            comportement de l'application, une erreur à ce niveau aurait des conséquences directes
          ...
          <p>
            ...
            Bien que cela ne remplace pas un véritable environnement de recette, cela permet de
            tester les développements dans des conditions proches de la production avant de merger.
          </p>
        </section>
        ...
        <section className="competence-sub-item">
          ...
          <p>
            ...
            <br />
            Les retours des utilisateurs sont très positifs. L'outil leur permet désormais d'opérer
            en totale autonomie sur l'ensemble des tâches du quotidien, sans avoir à solliciter un
            ...
            d'une visibilité en temps réel sur les indicateurs clés de la plateforme, ce qui
            facilite le pilotage des décisions stratégiques. Le responsable commercial et marketing
            peut gérer de manière autonome les discounts, les campagnes de communication et les
            certifications, sans dépendance technique. Enfin, la traçabilité introduite par les
            comptes individuels permet désormais de savoir précisément quelle action a été réalisée
            par quel utilisateur, un point essentiel pour une application manipulant des données
            sensibles.
          </p>
          ...
          <p>
            ...
            et l’ajout de certains onglets manquants dans la page des statistiques, afin d'offrir
            une vision encore plus complète des performances de la plateforme. L'environnement de
            staging, évoqué précédemment, fait également partie des prochaines étapes techniques
            prévues.
        ...
        <section className="competence-sub-item">
          ...
          <p>
            ...
            du projet. Tester sur une URL de branche Cloudflare est utile mais insuffisant, et j'ai
            pris conscience au fil du temps que l'absence de recette représente un risque réel.
            J'aurais également investi davantage dans les tests dès les premières semaines, plutôt
            que de les ajouter progressivement : une base de tests solide dès le départ aurait rendu
            les mises en production encore plus sereines.
          </p>
        </section>
      </article>
