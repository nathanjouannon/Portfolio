      ...
      <article className="competence-detail" aria-labelledby="organisation-title">
        ...
        <section className="competence-sub-item">
          ...
          <p>
            ...
            logiciel" au sein de l'ISCOD, préparant un RNCP de niveau 7. Il s'agit d'un projet
            d'étude mené en autonomie et en solitaire, sans équipe réelle. Dans ce scénario fictif,
            je suis chef de projet de la start-up O'Fit, spécialisée dans le développement
            d'applications de santé connectée. À ce titre, je suis responsable de la coordination de
            toutes les phases du projet, de la communication avec les parties prenantes et de la
            gestion de l'équipe. Mon rôle est exclusivement orienté pilotage : je ne touche pas
            directement au code.
          </p>
        </section>
        ...
        <section className="competence-sub-item">
          ...
          <p>
            ...
            personnalisation avancées, s'appuyant sur l'analyse des données utilisateurs pour
            délivrer des conseils de santé adaptés à chaque profil.
          </p>
        </section>
        ...
        <section className="competence-sub-item">
          ...
          <p>
            ...
            formalisée. Le budget alloué au projet est conséquent, avec une carte blanche accordée
            par le CEO, mais des attentes élevées en termes de résultats et une pression forte pour
            livrer rapidement.
            <br />
            <br />
            ...
            junior, sans développeur senior pour assurer un encadrement technique. Le designer
            manque d'autonomie, notamment sur les tests utilisateurs, et certains membres
            s'impliquent peu dans les discussions collectives.
            <br />
            <br />
            ...
            structurés, ce qui génère des malentendus fréquents sur les spécifications, des retards
            et des révisions constantes des exigences. Le périmètre du projet reste instable, avec
            un risque réel de dette technique si la cadence de livraison prime sur la qualité.
            <br />
            <br />
        ...
        <section className="competence-sub-item">
          ...
          <p>
            ...
            central. La valeur de l'application repose en grande partie sur sa capacité à
            centraliser les données de santé issues de plateformes externes comme Apple Health ou
            Google Fit. Cette synchronisation doit être fiable et transparente pour l'utilisateur.
          </p>
        </section>
        ...
        <section className="competence-sub-item">
          ...
          <p>
            ...
            <br />
            <br />
            Le deuxième risque concerne la sécurité des données. L'application traite des
            informations de santé particulièrement sensibles. Sans expertise solide en chiffrement
            et en gestion des consentements, une faille est vite arrivée. Les conséquences seraient
            immédiates : plainte d'un utilisateur, enquête de la CNIL, et une image durablement
            abîmée auprès du grand public.
            <br />
            <br />
            Le troisième risque est celui d'une mauvaise adoption par les utilisateurs. Une
            interface mal pensée ou insuffisamment testée peut suffire à faire échouer le produit
            commercialement. Ce risque est particulièrement réel pour les personnes plus âgées,
            moins à l'aise avec les applications mobiles, qui n'hésiteront pas à désinstaller
            l'application au moindre blocage.
          </p>
        </section>
        ...
        <section className="competence-sub-item">
          ...
          <p>
            Pour assurer un suivi structuré du projet, un rapport d'analyse des risques a été
            rédigé, accompagné d'une matrice de risques permettant de visualiser et hiérarchiser les
            menaces identifiées selon leur probabilité et leur impact. En parallèle, une liste de
            KPI a été définie afin de disposer d'indicateurs concrets pour mesurer l'avancement du
            projet tout au long de son développement.
          </p>
          ...
          <p>
            ...
            des lacunes en sécurité, conformité RGPD, architecture logicielle et DevOps. Par
            ailleurs, l'absence de CTO posait un problème de structure, l'équipe n'étant pas formée
            aux méthodes agiles et manquant donc d'un cadre de travail clair. Enfin, l'audit a
            révélé des difficultés dans la communication et la collaboration au sein de l'équipe,
            avec un nombre de réunions insuffisant.
            <br />
            <br />
            ...
            l'implémentation de tests et d'une pipeline CI/CD. Les mois suivants, de trois à six,
            seraient dédiés à la montée en compétence et à l'optimisation continue.
          </p>
        </section>
        ...
        <section className="competence-sub-item">
          ...
          <p>
            Ce projet représente pour moi une bonne expérience de pilotage, aussi bien sur le plan
            des fonctionnalités que sur celui de l'équipe. Il m'a permis de comprendre qu'il ne faut
            pas négliger le pilotage humain : gérer les compétences, les dynamiques d'équipe et les
            ...
            équipe, afin de mesurer concrètement son efficacité et d'en tirer davantage
            d'expérience.
          </p>
        </section>
      </article>
