    ...
    <article className="competence-detail" aria-labelledby="organisation-title">
      ...
      <section className="competence-sub-item">
        ...
        <p>
          ...
          phase de conception et couvre un spectre large : du développement du code lui-même (qu'il
          s'agisse d'un frontend web ou mobile, ou d'un backend) jusqu'à sa mise en production et
          son cycle de vie applicatif.
          <br />
          <br />
          ...
          l'organisation du travail. Elle conditionne directement la capacité d'une équipe à livrer
          de la valeur de manière régulière, rapide et maîtrisée.
        </p>
      </section>
      <section className="competence-sub-item">
        ...
        <p>
          ...
          <br />
          <br />
          Chez hbond, j'ai contribué à deux projets distincts qui m'ont confronté à des contextes de
          déploiement très différents. Sur le projet d'administration interne, j'ai développé le
          frontend web en TypeScript avec React, et participé à la mise en place de tests
          automatisés pour fiabiliser les livraisons. Sur le projet d'application mobile, développée
          en TypeScript avec React Native, j'ai géré plusieurs mises en production sur l'App Store
          via App Store Connect et sur le Play Store via Google Play Console. J'ai également utilisé
          le mécanisme d'Expo OTA (Over The Air) qui permet de pousser des mises à jour mineures
          directement sur les appareils des utilisateurs, sans passer par le processus de validation
          des stores. C'est une approche particulièrement utile pour corriger rapidement des bugs ou
          déployer de petites évolutions sans friction.
          <br />
          <br />
          ...
          Compose pour orchestrer les services. J'ai ajouté des tests automatisés et mis en place un
          pipeline CI/CD qui publie automatiquement une image sur Docker Hub à chaque intégration.
          C'est sur ce projet que j'ai le mieux appréhendé la chaîne complète, de l'écriture du code
          jusqu'à la distribution automatisée d'un artefact prêt à déployer.
        </p>
      </section>
      <section className="competence-sub-item">
        ...
        <p>
          ...
          <br />
          <br />
          Le seul point sur lequel je reste plus réservé est la dockerisation. Non pas parce que le
          concept me pose problème, j'ai eu l'occasion de le mettre en pratique sur le projet MPMT,
          mais parce que je n'y reviens pas assez régulièrement pour que cela devienne un
          automatisme. La configuration d'environnements Docker et l'orchestration avec Docker
          Compose demandent une pratique soutenue pour être maîtrisées avec aisance, et le manque de
          fréquence se fait sentir dès que les cas d'usage deviennent un peu plus complexes.
          <br />
          <br />
      ...
      <section className="competence-sub-item">
        ...
        <p>
          ...
          l'entreprise souhaite déployer Expo sur un VPS afin de pouvoir distribuer des mises à jour
          de l'application mobile à l'ensemble des utilisateurs de manière autonome et économique,
          sans dépendre entièrement des stores. C'est un projet de déploiement plus complexe que ce
          que j'ai eu l'occasion de réaliser jusqu'ici, et je le vois comme une opportunité directe
          d'approfondir mes compétences sur des infrastructures réelles et des contraintes de
          production concrètes.
        </p>
      </section>
    </article>
  )
