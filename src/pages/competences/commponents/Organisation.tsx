      ...
      <article className="competence-detail" aria-labelledby="organisation-title">
        ...
        <section className="competence-sub-item">
          ...
          <p>
            ...
            nommé comme leader de ce projet, ainsi, j’ai réalisé les tâches d’organisation du
            travail entre mes collaborateurs, avec par exemple la création et la gestion des
            “issues” (unité de travail correspondant à une tâche à réaliser).
            <br />
            <br />
            ...
            les différentes pages et sous-pages pour pouvoir rapidement retrouver les informations
            que l’on cherche comme par exemple les documentations techniques de certaines
            fonctionnalités possibles via API mais qui ne disposent pas d’interface visuelle.
          </p>
        </section>
        <section className="competence-sub-item">
          ...
          <p>
            ...
            sport semi-professionnel et études supérieures. La gestion des emplois du temps où
            doivent cohabiter les séances d’entraînement avec les heures de cours et les heures de
            travail ne laisse pas d'autre choix que d’avoir une bonne organisation.
            <br />
            ...
            tâches que je dois faire sous forme de check-list. Je pense qu’il s’agit d’une bonne
            pratique. Néanmoins, avec cette habitude, si l’on oublie de noter une tâche, alors on
            oublie complètement de la réaliser. Un travail mental pour mieux retenir les différentes
            tâches sans pour autant les noter peut être quelque chose à faire.
          </p>
        </section>
        <section className="competence-sub-item">
          ...
          <p>
            ...
            Néanmoins, l’organisation a pris une autre dimension dans le cadre de la gestion de
            projet depuis que j’utilise Linear.
            <br />
