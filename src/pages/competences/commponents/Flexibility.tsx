    ...
    <article className="competence-detail" aria-labelledby="organisation-title">
      ...
      <section className="competence-sub-item">
        ...
        <p>
          ...
          gérer au mieux un projet ou des délais de livraison. Cette compétence est très importante
          dans la vie d’un expert en ingénierie du logiciel pour les raisons précédentes.
        </p>
      </section>
      <section className="competence-sub-item">
        ...
        <p>
          ...
          flexibilité a été mise à profit. Je pense notamment à deux situations : la première est la
          détection d’un bug en production, et la deuxième est un changement brutal de priorité.
          <br />
          <br />
          La première situation intervient dans une phase calme du développement de l’interface
          admin de l’entreprise. Nous avancions par itérations courtes et constantes. Je travaillais
          sur la réalisation d’une page permettant la visualisation de statistiques. Mon
          collaborateur, utilisateur de l’admin hbond, m’a fait part d’un problème qu’il a rencontré
          en production sur la fonctionnalité de création d’une discount temporaire. Dans le cas où
          la discount est temporaire, le formulaire change et affiche deux champs supplémentaires
          permettant de choisir une date de début et une date de fin. Cette fonctionnalité n’était
          plus disponible. Il a alors fallu immédiatement changer de tâche pour réparer cette
          fonctionnalité au plus vite car elle bloquait l’équipe marketing.
          <br />
          <br />
          ...
          contrats hors France, ce projet était en suspens. Après la signature de 6 contrats dans la
          même semaine, ce projet Europe est devenu la priorité numéro 1 de toute l’équipe de
      ...
      <section className="competence-sub-item">
        ...
        <p>
          ...
          gros frein est le temps que je mets à rentrer dans le sujet. En effet, il me faut un temps
          trop grand pour réussir à me concentrer sur un sujet spécifique, d’autant plus s’il est
          complexe. Je compte environ 15 minutes. Je pense que ce temps devrait être réduit à moins
          de 5 minutes.
        </p>
      </section>
      <section className="competence-sub-item">
        ...
        <p>
          L’objectif d’évolution est de continuer à progresser sur la rapidité de passage d’un sujet
          à l’autre, d’autant plus sur les tâches avec une grande complexité. L’idée est de mettre
          moins de temps pour rentrer dans le sujet. Je pense discuter avec mes pairs, mes
