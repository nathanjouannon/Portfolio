  ...
  return (
    <section className="competences-page" aria-labelledby="competences-title">
      {competenceGroups.map((group) => (
        <div key={group.id} className="competences-shell" style={{ marginBottom: 30 }}>
          <h1 id="competences-title" className="competences-title">
            {group.title}
          </h1>

          <ul
            className={`competence-list ${
              group.id === 'human-skills-title'
                ? 'competence-list-human'
                : 'competence-list-technical'
            }`}
          >
